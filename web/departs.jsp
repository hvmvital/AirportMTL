       ...
       -->
        ...
        <div class="section row p-3">
            ...
            <div class="input-group mb-3 p-0 col-12 ">
                <form class="input-group" action="departs" method="GET">
            ...
            <a  href="#" 
                ...
                role="button">AUJOURD'HUI
            </a>       

            <!--BTN DEMAIN-->
            <a href="#" 
               id="bntTomorrow" 
               class="btn btn-warning col-6 col-sm-3" 
               role="button">DEMAIN</a> 
